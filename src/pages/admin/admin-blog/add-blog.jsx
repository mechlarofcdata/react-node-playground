      ...
      <div className="topbar">
        <div>
          ...
          <div className="page-sub">
            Create and publish content to your users.
          </div>
        </div>
        ...
        <div>
          <form className="card" onSubmit={handleSubmit}>
            ...
            <div className="editor-toolbar">
              ...
              <button title="H1" type="button">
                H1
              </button>
              <button title="H2" type="button">
                H2
              </button>
              <button title="H3" type="button">
                H3
              </button>
              <div className="divider"></div>
              ...
              <button title="Quote" type="button">
                "
              </button>
              <button title="Code" type="button">
                &lt;/&gt;
              </button>
            </div>
            <textarea
        ...
        <div>
          ...
          <div className="card">
            ...
            <div>
              ...
              <div>
                {data.summary || "Short description will appear here..."}
              </div>
            </div>
          </div>
        </div>
